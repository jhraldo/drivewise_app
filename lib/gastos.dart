...
class GastosPage extends StatelessWidget {
  ...
  final ValueNotifier<List<Gasto>> gastosNotifier = ValueNotifier<List<Gasto>>([
    Gasto(
      categoria: 'Aceite',
  ...
  Future<void> agregarGasto(BuildContext context) async {
    final nuevoGasto = await Navigator.push<Gasto>(
      context,
      MaterialPageRoute(builder: (context) => const NuevoGastoPage()),
    );

    if (nuevoGasto != null) {
      gastosNotifier.value = [nuevoGasto, ...gastosNotifier.value];
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ValueListenableBuilder<List<Gasto>>(
        valueListenable: gastosNotifier,
        builder: (context, gastos, child) {
          final totalGastado = gastos.fold<double>(
            0,
                    ...
                    return Card(
                      ...
                      child: ListTile(
                        leading: CircleAvatar(
                          child: Icon(iconoCategoria(gasto.categoria)),
                        ),
